package com.example.shopinterior.dto.request;
...
public class UpdateUserForm {
    ...
    public void validate(List<Account> list, UpdateUserForm updateUserForm, Errors error) {
        for (int i = 0; i < list.size(); i++) {
            if (Objects.equals(list.get(i).getUsernameAccount(), updateUserForm.getUsername())) {
                continue;
            }
            if (Objects.equals(list.get(i).getEmailAccount(), updateUserForm.getEmail())) {
